            ...
            <c:forEach items="${albums}" var="album">
                <div class="picture">
                    <p><a href="/album/${album.id}">
                        ...
                        <img src="${album.pictures[random.nextInt(album.pictures.size())].directory}" id="myPicture"
                    ...
                    <div class="item-content">
                        <div class="description">
                            <p align="center"><a id=${album.id+2} href="/album/${album.id}">${album.name}</a>
                                <security:authorize access="hasRole('ROLE_ADMIN')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a id=${album.id} onclick="showInput(${album.id+2})" class="btn btn-warning btn-sm"
