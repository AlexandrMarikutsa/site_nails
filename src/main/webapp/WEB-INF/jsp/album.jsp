                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="active item" data-slide-number="0" align="center">
                            <security:authorize access="hasRole('ROLE_ADMIN')">
                                <a href="/admin/updatePhoto/${pictures[0].id}" class="btn btn-warning btn-sm"
                                   style="padding: 0; border: 3px">Update</a>
                                <a href="/admin/deletePhoto/${pictures[0].id}/${albumId}" class="btn btn-danger btn-sm"
                                   style="padding: 0; border: 3px">Delete</a>
                                </p>
                            </security:authorize>
                            <img src="${pictures[0].directory}" class="img-responsive">
                        </div>
                        <c:forEach items="${pictures}" var="picture" begin="1" end="${fn:length(pictures)}"
                                   varStatus="status">
                            <div class="item" data-slide-number="status" align="center">
                                <security:authorize access="hasRole('ROLE_ADMIN')">
                                    <a href="/admin/updatePhoto/${picture.id}" class="btn btn-warning btn-sm"
                                       style="padding: 0; border: 3px">Update</a>
                                    <a href="/admin/deletePhoto/${picture.id}/${albumId}" class="btn btn-danger btn-sm"
                                       style="padding: 0; border: 3px">Delete</a>
                                    </p>
                                </security:authorize>
